...
def title_screen():
    ...
    while True:
        ...
        if tick % 60 < 30:
            start = _font_med.render("PRESS  ENTER  TO  START", True, YELLOW)
            _screen.blit(start, (W // 2 - start.get_width() // 2, H - 120))
        ...
        for i, line in enumerate(controls):
            ...
            _screen.blit(t, (W // 2 - t.get_width() // 2, H - 72 + i * 17))
...
def pause_screen(surf, sound_on=True):
    """Semi-transparent pause overlay. Returns ('resume'|'restart'|'menu', sound_on)."""
    overlay = surf.copy()
    ...
    while True:
        ...
        sub = _font_tiny.render("R/ESC : Resume   N : New   M : Sound   Q : Menu", True, GREY)
